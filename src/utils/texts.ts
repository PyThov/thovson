...
export const ABOUT: IPageDetail = {
  "Software Engineer":
    "Enjoying coding since 2016. What started with highschool courses has grown into a fulfilling career. I prefer the frontend but I like being a part of an entire project, end-to-end.",
  Gamer:
