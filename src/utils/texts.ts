...
export const ABOUT: IPageDetail = {
    "Software Engineer": "I've been enjoying coding since 2016, starting with highschool courses and growing into a fulfilling career. I enjoy all parts of a project; back-end to front-end. My only hope is for some more side-projects outside of work.",
