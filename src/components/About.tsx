...
export default function About() {
  return (
    <Box>
      ...
      <Grid container justifyContent="center" textAlign="center" direction="column" spacing={4}>
        <Grid item xs={6}>
            {/* <img src="/noah_t.png" width="100%" alt="Noah Thovson Portrait" /> */}
            <Card sx={{backgroundColor: "primary.light", marginX: "8vw"}}>
              <Paper elevation={6}>
                <CardMedia
                  component="img" image="/noah_t.png" title="Noah Thovson Portrait" />
              </Paper>
              <Typography variant="h5" marginY="6px">
                Noah Thovson
              </Typography>
            </Card>
        </Grid>
